...
## T-rex
To demonstrate the potential of the watch, I wrote a clone of Google T-Rex game. The game sources and a binary ready to be sent to the watch are [here](https://github.com/azya52/epson/tree/master/apps/my).<br/>
